...
#ifndef P467_ENABLE
#define P467_ENABLE 0   /* ★P533: D-40調査(H2=GVRAM_FastClearの非ラップ書込み)の実測のため
                         ...
                         * ★★P758(2026-09-19): 役目を終えたため0へ復元。再度D-4x調査が必要に
                         *   なれば1へ戻すこと。 */
#endif
#if P467_ENABLE
...
#define P468_ENABLE 0   /* ★P533: D-40調査(H2)の実測のため、このサイクル限定で一時的に 1 へ戻した。
                         ...
                         * ★★P758(2026-09-19): 役目を終えたため0へ復元(m68000_bridge.c 側も同時に
